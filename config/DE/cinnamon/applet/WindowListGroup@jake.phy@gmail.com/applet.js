...
AppGroup.prototype = {
    ...
    _onScrollEvent: function (actor, event) {
        ...
        if (direction == Clutter.ScrollDirection.DOWN) {
             ...
             let w=wins[wins.length-1]; //dont know how to get the other window
             w.activate(global.get_current_time()); 
        }
    },
